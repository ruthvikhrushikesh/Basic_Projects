...
//  example     k=pawn(arr,row,col,ROW,COL,0);  here k is storing the value which is return value from the function pawn
    ...
    if(arr[row][col]=='A' || arr[row][col]=='a'){
        ...
        if(k==1){
            printf("elephant doesnt move like that:\n");
            return 0;
        }
        ...
        if(k==1){
            printf("camel doesnt move like that:\n");
            return 0;
        }
    }
        ...
        if(k==1){
            k=camel(arr,row,col,ROW,COL);
            if(k==1){
                printf("queen doesnt move like that:\n");
                return 0;
            }
        }
    }
        ...
        if(k==1){
            printf("horse doesnt move like that:\n");
            return 0;
        }
    }
